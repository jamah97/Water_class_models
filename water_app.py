...
def main():
	...
	st.write("You will be able to select from any of the 9 variables as predictors along with the classifier algorithm and the train test split. By default the independent variable is potability. potability of 1 means water is safe to drink and 0 means water isn't safe to drink. After clicking on model performance, the application will generate the accuracy of the model along with the predicted class. ")
